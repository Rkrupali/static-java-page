        ...
        String htmlContent = """
           <!DOCTYPE html>
            ...
            <body>
              ...
              <div class="container">
                <article>
                  <h2>🌟 Welcome to Rupali's First Blog Post</h2>
                  <p><strong>Date:</strong> July 26, 2025</p>
                  <p>
                    Hello Rupali! This is my first post on my static blog website. I created this page using only HTML and CSS, no JavaScript or frameworks needed. It's fast, simple, and easy to maintain.
                  </p>
                </article>
